...
--
-- Host: localhost
-- Generation Time: Sep 12, 2012 at 06:54 AM
...
INSERT INTO `events` (`event_id`, `event_title`, `event_posted_date`, `event_description`, `event_attachment`) VALUES
(1, 'Graduation Ceremonies', '2012-09-12 13:35:25', 'This is to inform all students..', '');
...
INSERT INTO `news` (`nws_id`, `nws_title`, `nws_posted_date`, `nws_description`, `nws_attachment`) VALUES
