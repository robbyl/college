...
jQuery.fn.wowSlider = function(x) {
    ...
    M = X ? D(M) : X;
    if (M) {
        M.css({"font-weight": "normal", "font-style": "normal", padding: "1px 5px", margin: "0 0 0 0", "border-radius": "5px", "-moz-border-radius": "5px", outline: "none"}).attr({href: "http://" + d.toLowerCase()}).html(d).bind("contextmenu", function(c) {
            return false
...
function wowsliderPreloader(m, d) {
    var f = jQuery, j = d.images, n = [], q = d.logo || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
    function h(t, u) {
        var i = new Image();
        if (u) {
