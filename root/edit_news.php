            ...
            <div class="content">
                <div class="tabwrapper">
                    ...
                    <div class="tab_content" id="tab1" style="display:none" >
                        ...
                        <h2 class="label">Edit <?php echo $row['nws_title']?> news</h2>
                        <div class="form-wrapper">
                            <form id="news" action="process_edit_news.php" method="POST" enctype="multipart/form-data">
                                <table border="0" width="100%">
                                    <tr>
                                        <td width="200">Title</td>
                                        <td><input type="text" name="title" value="<?php echo $row['nws_title']?>"class="text" required></td>
                                    </tr>
                                    <tr>
                                        <td>Image</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="description" required=""><?php echo $row['nws_title']?></textarea></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
